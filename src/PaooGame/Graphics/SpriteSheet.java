...
public class SpriteSheet
{
    ...
    private static final int    tileWidth   = 512;   // Latimea unei dale din sprite sheet.*///cum e ea in Spriteshheet
    private static final int    tileHeight  = 512;   // Inaltime unei dale din sprite sheet
    ...
    public BufferedImage crop(int x, int y, int Width, int Height) //pt imagini care nu sunt patrate la fix :)
    {
