...
/*! \class public class IarbaColtDrt3 extends Tile
    \brief Abstractizeaza notiunea de dala de tip iarbaColtDrt3.
 */
public class IarbaColtDrt3 extends Tile {
    /*! \fn public SoilTile(int id)
        \brief Constructorul de initializare al clasei

        \param id Id-ul dalei util in desenarea hartii.
     */
    public IarbaColtDrt3(int id) {
        super(Assets.iarbaColtDrt3, id);
    }
