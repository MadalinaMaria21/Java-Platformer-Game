...
/*! \class public class IarbaColtDrt2 extends Tile
    \brief Abstractizeaza notiunea de dala de tip iarbaColtDrt2.
 */
public class IarbaColtDrt2 extends Tile {
    /*! \fn public SoilTile(int id)
        \brief Constructorul de initializare al clasei

        \param id Id-ul dalei util in desenarea hartii.
     */
    public IarbaColtDrt2(int id) {
        super(Assets.iarbaColtDrt2, id);
    }
