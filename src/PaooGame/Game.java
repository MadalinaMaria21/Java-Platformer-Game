...
public class Game implements Runnable
{
   ...
   // private Gravity gravity;
    ...
    private State storyState;           /*!< Referinta catre story.*/
    private State infoState;            /*!< Referinta catre info.*/
    private State scoreState;            /*!< Referinta catre scor.*/
    private State endLevelState;
    ...
    private void InitGame() throws FileNotFoundException {
        ...
        wnd.BuildGameWindow();
            ///Sa ataseaza ferestrei managerul de tastatura si mouse ul pentru a primi evenimentele furnizate de fereastra.
        wnd.GetWndFrame().addKeyListener(keyManager);
        wnd.GetWndFrame().addFocusListener(keyManager);
    ...
    public void ResetGame() throws FileNotFoundException {
        ...
        //sterg instantele obiectelor singleton
        Score.RemoveInstance();
        Hero.RemoveInstance();
        ...
        //creez un nou obiect de tip scor
        Score.GetInstance();
    ...
    private void Update() throws FileNotFoundException, SQLException {
        ...
        // actualizează starea gravitației
     //   gravity.Update(keyManager);
    ...
    public StoryState getStoryState() {
        ...
        return (StoryState) storyState;
    }
    public InfoState getInfoState() {
        return (InfoState) infoState;
    }
    public ScoreState getScoreState() {
        return (ScoreState) scoreState;
    }

    public EndLevelState getEndLevelState() {
        return (EndLevelState) endLevelState;
    }
}
